        ...
        <>
            ...
            <main className="h-full">
              <section className=" flex w-3/4 p-10 flex-col max-md:p-2  justify-center-center">
                <p className="font-light text-6xl  max-lg:text-5xl text-white ">
                    Aproveite esta oportunidade<br />
                    E participe do nosso
                    <b className="font-bold"> Bootcamp <br /> Jovem Programador!</b>
                </p> 
                <button onClick={() => navigate("/register")} className="w-96 mt-10 h-36 max-lg: max-sm:w-3/4 max-sm:h-24 max-sm:text-4xl  text-5xl font-medium text-white text-center rounded-2xl bg-blue-2 mr-4 max-sm:mr-0  mb-40">Inscreva-se</button>
              </section>
              <section className=" flex bg-white max-lg:flex-col ">
                <div className="w-1/2 flex flex-col max-lg:w-full items-start p-16 max-lg:p-2 justify-start">
                    <p className="text-5xl max-md:text-4xl  text-blue-1 mb-20 max-lg:mt-20">Por que participar
                    dos<b> Bootcamps?</b></p>
                ...
                <div className="w-1/2 flex flex-col items-start p-16 max-lg:mt-20 max-lg:p-2 justify-start max-lg:w-full max-lg:h-full max-lg:mb-20">                    
