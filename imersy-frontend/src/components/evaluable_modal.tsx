...
export function EvaluableModal({id, setShowModal}:{id:number, setShowModal: (smodal:boolean) => void}) {
    ...
    return (
        <div className="fixed inset-0 bg-white/40 flex items-center justify-center 	">
          <div className="w-1/4 max-xl:w-1/2 max-md:w-full max-md:mx-2 h-auto border-4 border-white rounded-2xl bg-blue-2 flex flex-col px-10 py-5 ">
