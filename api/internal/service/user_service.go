...
func (us *UserService) GetProjectsByCategorie(userID int64, categorie string)([]*model.Project, error) {
	projects, err := us.userDB.GetProjectsByCategorie(userID,categorie)
	if err != nil {
		return nil, err 
	}
	return projects, nil
